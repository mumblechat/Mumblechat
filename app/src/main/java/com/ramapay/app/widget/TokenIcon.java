...
import static com.ramapay.app.util.Utils.RAMAPAY_REPO_NAME;
import static com.ramapay.app.util.Utils.TRUST_ICON_REPO_BASE;
...
import com.ramapay.app.viewmodel.TokenIconViewModel;
...
public class TokenIcon extends ConstraintLayout
{
    ...
    private void displayTokenIcon(String iconUrl)
    {
        ...
        final RequestOptions optionalCircleCrop = squareToken || iconUrl.startsWith(RAMAPAY_REPO_NAME) ? new RequestOptions() : new RequestOptions().circleCrop();
    ...
    private void loadFromAltRepo(Object model)
    {
        ...
        if (checkUrl.startsWith(RAMAPAY_REPO_NAME))
        {
            useContractURI = true;
        }
