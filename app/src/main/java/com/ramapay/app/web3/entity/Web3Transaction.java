package com.ramapay.app.web3.entity;
...
import com.ramapay.app.entity.walletconnect.SignType;
import com.ramapay.app.repository.EthereumNetworkBase;
import com.ramapay.app.util.BalanceUtils;
import com.ramapay.app.util.Hex;
import com.ramapay.app.util.StyledStringBuilder;
...
public class Web3Transaction implements Parcelable
{
     ...
     * @param minGas
     */
    public Web3Transaction(com.ramapay.app.entity.Transaction tx, ActionSheetMode mode, BigInteger minGas)
    {
