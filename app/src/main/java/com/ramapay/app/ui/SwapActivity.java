...
import com.ramapay.app.entity.analytics.TokenSwapEvent;
import com.ramapay.app.entity.lifi.Chain;
import com.ramapay.app.entity.lifi.Connection;
import com.ramapay.app.entity.lifi.Quote;
import com.ramapay.app.entity.lifi.Token;
...
import com.ramapay.app.ui.widget.entity.ProgressInfo;
import com.ramapay.app.util.BalanceUtils;
import com.ramapay.app.util.SwapUtils;
import com.ramapay.app.viewmodel.SwapViewModel;
import com.ramapay.app.viewmodel.Tokens;
...
import com.ramapay.app.widget.SelectTokenDialog;
import com.ramapay.app.widget.StandardHeader;
import com.ramapay.app.widget.SwapSettingsDialog;
import com.ramapay.app.widget.TokenInfoView;
import com.ramapay.app.widget.TokenSelector;
...
public class SwapActivity extends BaseActivity implements StandardFunctionInterface, ActionSheetCallback
{
    ...
    private com.ramapay.app.entity.tokens.Token token;
    ...
    private ActionSheetDialog createConfirmationAction(Quote quote)
    {
        ...
        try
        {
            com.ramapay.app.entity.tokens.Token activeToken = viewModel.getTokensService().getTokenOrBase(sourceToken.chainId, sourceToken.address);
