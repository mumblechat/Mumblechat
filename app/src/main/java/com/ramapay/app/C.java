...
public abstract class C {
    ...
    public static final String RAMAPAY_WEB = "https://www.ramestta.com";
    ...
    public static final String PRUNE_ACTIVITY =
            "com.ramapay.wallet.PRUNE_ACTIVITY";

    public static final String RESET_WALLET =
            "com.ramapay.wallet.RESET";
    public static final String ADDED_TOKEN =
            "com.ramapay.wallet.ADDED";
    public static final String CHANGED_LOCALE =
            "com.ramapay.wallet.CHANGED_LOCALE";
    public static final String PAGE_LOADED =
            "com.ramapay.wallet.PAGE_LOADED";
    public static final String RESET_TOOLBAR =
            "com.ramapay.wallet.RESET_TOOLBAR";
    public static final String SIGN_DAPP_TRANSACTION =
            "com.ramapay.wallet.SIGN_TRANSACTION";
    public static final String REQUEST_NOTIFICATION_ACCESS =
            "com.ramapay.wallet.REQUEST_NOTIFICATION";
    public static final String BACKUP_WALLET_SUCCESS =
            "com.ramapay.wallet.BACKUP_SUCCESS";
    public static final String CHANGE_CURRENCY =
            "com.ramapay.wallet.CHANGE_CURRENCY";
    public static final String RESET_TRANSACTIONS =
            "com.ramapay.wallet.RESET_TRANSACTIONS";
    public static final String WALLET_CONNECT_REQUEST =
            "com.ramapay.wallet.WALLET_CONNECT";
    public static final String WALLET_CONNECT_NEW_SESSION =
            "com.ramapay.wallet.WC_NEW_SESSION";
    public static final String WALLET_CONNECT_FAIL =
            "com.ramapay.wallet.WC_FAIL";
    public static final String WALLET_CONNECT_COUNT_CHANGE =
            "com.ramapay.wallet.WC_CCHANGE";
    public static final String WALLET_CONNECT_CLIENT_TERMINATE =
            "com.ramapay.wallet.WC_CLIENT_TERMINATE";
    public static final String WALLET_CONNECT_SWITCH_CHAIN =
            "com.ramapay.wallet.WC_SWITCH_CHAIN";
    public static final String WALLET_CONNECT_ADD_CHAIN =
            "com.ramapay.wallet.WC_ADD_CHAIN";
    public static final String SHOW_BACKUP = "com.ramapay.wallet.CHECK_BACKUP";
    public static final String HANDLE_BACKUP = "com.ramapay.wallet.HANDLE_BACKUP";
    public static final String KEY_ERROR = "com.ramapay.wallet.KEY_ERROR";
    public static final String FROM_HOME_ROUTER = "HomeRouter";
    public static final String TOKEN_CLICK = "com.ramapay.wallet.TOKEN_CLICK";
    public static final String SETTINGS_INSTANTIATED = "com.ramapay.wallet.SETTINGS_INSTANTIATED";
    public static final String APP_FOREGROUND_STATE = "com.ramapay.APP_FOREGROUND_STATE";
    public static final String EXTRA_APP_FOREGROUND = "com.ramapay.IS_FOREGORUND";
    public static final String QRCODE_SCAN = "com.ramapay.QRSCAN";
    public static final String AWALLET_CODE = "com.ramapay.AWALLET";
    public static final String SIGNAL_NFT_SYNC = "com.ramapay.SYNC_NFT";
    public static final String SYNC_STATUS = "com.ramapay.SYNC_STATUS";
    ...
    public static final String DAPP_PREFIX_RAMAPAY = "ramapay";
    ...
    public static final String RAMAPAY_LOGO_URI = "https://ramestta.com/assets/images/logo.png";
    public static final String RAMAPAY_WEBSITE = "https://ramestta.com";
    public static final String WALLET_CONNECT_REACT_APP_RELAY_URL = "wss://relay.walletconnect.com";
    public static final String RAMAPAY_LOGO_URL = "https://ramestta.com/assets/images/logo.png";
    ...
    public static final String EXTERNAL_APP_DOWNLOAD_LINK = "https://github.com/obidua/RamaPay-android/releases/latest/download/RamaPay.apk";
