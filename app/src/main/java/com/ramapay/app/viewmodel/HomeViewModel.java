...
import com.ramapay.app.ui.AddTokenActivity;
import com.ramapay.app.ui.HomeActivity;
import com.ramapay.app.ui.ImportWalletActivity;
import com.ramapay.app.ui.SendActivity;
import com.ramapay.app.ui.WalletConnectV2Activity;
...
import com.ramapay.app.widget.EmailPromptView;
import com.ramapay.app.widget.QRCodeActionsView;
import com.ramapay.app.widget.WhatsNewView;
...
{
    public static final String RAMAPAY_DIR = "RamaPay";
    ...
    private Request getRequest()
    {
        return new Request.Builder()
            ...
            .url("https://api.github.com/repos/obidua/RamaPay-android/releases")
            .get()
            .build();
    }
    ...
    {
        ramaPayNotificationService.subscribe(com.ramapay.ethereum.EthereumNetworkBase.MAINNET_ID);
    }

    public void unsubscribeToNotifications()
    {
        ramaPayNotificationService.unsubscribeToTopic(com.ramapay.ethereum.EthereumNetworkBase.MAINNET_ID);
    }
