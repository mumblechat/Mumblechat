...
import static com.ramapay.token.tools.TokenDefinition.Syntax.IA5String;
...
public class TokenScriptResult
{
    public static final class Attribute {
        ...
        public Attribute(com.ramapay.token.entity.Attribute attr, BigInteger value, String text)
        {
            this.id = attr.name;
