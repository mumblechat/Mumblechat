...
async function main() {
    console.log("═══════════════════════════════════════════════════════════════════════");
    console.log("   MumbleChat Protocol - Continue V4 Deployment");
    console.log("   Upgrade Registry + Link to RelayManager");
    console.log("═══════════════════════════════════════════════════════════════════════\n");
    ...
    // RelayManager already deployed
    const relayManagerProxy = "0xF78F840eF0e321512b09e98C76eA0229Affc4b73";
    const relayManagerImpl = "0xb9E673952e25E6E86745264B90FBC82b50ffb067";
    
    console.log("📦 MCT Token Proxy:", mctTokenAddress);
    console.log("📦 Registry Proxy:", registryProxyAddress);
    console.log("📦 RelayManager Proxy (already deployed):", relayManagerProxy);
    
    // ═══════════════════════════════════════════════════════════════════════
    // STEP 1: Upgrade MumbleChatRegistry to V4 (Core version)
    // ═══════════════════════════════════════════════════════════════════════
    console.log("\n" + "═".repeat(75));
    console.log("   STEP 1: Upgrade MumbleChatRegistry to V4 (Core)");
    console.log("═".repeat(75) + "\n");
    
    console.log("1️⃣  Compiling MumbleChatRegistry V4 (Core)...");
    const RegistryCoreFactory = await ethers.getContractFactory("MumbleChatRegistry");
    
    console.log("2️⃣  Upgrading Registry proxy to V4 Core...");
    ...
    console.log("\n3️⃣  Calling initializeV4() with RelayManager address...");
    try {
    ...
    console.log("\n5️⃣  Verifying Registry V4 on Ramascan...");
    try {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    console.log("\n" + "═".repeat(75));
    console.log("   STEP 2: Testing Deployed Contracts");
    console.log("═".repeat(75) + "\n");
    
    console.log("6️⃣  Testing Registry V4 functions...");
    try {
    ...
    console.log("\n7️⃣  Testing RelayManager functions...");
    try {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // STEP 3: Update deployments.json
    // ═══════════════════════════════════════════════════════════════════════
    console.log("\n" + "═".repeat(75));
    console.log("   STEP 3: Updating deployments.json");
    console.log("═".repeat(75) + "\n");
    ...
    console.log("");
    console.log("   📦 MumbleChatRelayManager:");
