package com.ramapay.token.web;

import static com.ramapay.token.tools.Convert.getEthString;
import static com.ramapay.token.tools.ParseMagicLink.normal;
import static com.ramapay.token.web.Ethereum.TokenscriptFunction.ZERO_ADDRESS;
...
import com.ramapay.token.entity.MagicLinkInfo;
...
import com.ramapay.token.web.Ethereum.TokenscriptFunction;
import com.ramapay.token.web.Ethereum.TransactionHandler;
import com.ramapay.token.web.Service.CryptoFunctions;
...
public class AppSiteController implements AttributeInterface
{
    ...
    private static final String androidAssociationConfig = "[\n" +
            ...
            "      \"package_name\": \"com.ramapay.wallet\",\n" +
